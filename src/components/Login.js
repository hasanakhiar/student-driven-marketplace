...
const Login = () => {
  ...
  const validateUniversityEmail = (email) => {
    // Common university email domains - you can expand this list
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="rememberMe" className="body-small ml-2 text-gray-900">
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="body-small font-medium text-indigo-600 hover:text-indigo-500">
